...
#' Generalized Method of Moments Valid Moment Combination Derivatives for one Subject of Longitudinal Count (Poisson) Responses, User-Defined Types
#' 
...
validMDPoi_Types = function(yvec,subjectIndex,Zmat,Xmat,covTypeVec,betaI,T,Tmax){
