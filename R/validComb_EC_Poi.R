...
#' Generalized Method of Moments Valid Moment Combinations for Longitudinal Count (Poisson) Responses, using Extended Classification
#' 
#' This function calculates the values of valid moment combinations for two-step Generalized Method of Moments using the extended classification method, applied to longitudinal data with count (Poisson) outcomes.  It allows for unbalanced longitudinal data, meaning subjects can be observed for different numbers of times.  The function returns a vector "types" indicating validity of different moments conditions.  
...
validComb_EC_Poi = function(yvec,Zmat,Xmat,betaI,Tvec,alpha){
...
{
	# FIND DERIVATIVES #
	## SPECIFIC TO THE POISSON!! ##
	dBetamu_j_raw = mu*Xmat[,j] 
