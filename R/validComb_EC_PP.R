...
#' Generalized Method of Moments Valid Moment Combinations for Truncated Count Component of Longitudinal Excess-Zero Responses, using Extended Classification
#' 
...
validComb_EC_PP = function(yvec,Zmat,Xmat,betaI,Tvec,alpha,r){
...
{
	# FIND DERIVATIVES #
	## SPECIFIC TO THE POSITIVE POISSON!! ##
	dBetamu_j_raw = mu*(1-mu*(exp(-exp(eta))))*Xmat[,j] 
